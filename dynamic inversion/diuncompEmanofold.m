function [y1,t1]= diuncompEmanofold(i0,numsteps,dur)
...
ux=0;%(1/2)*((axr-(y(7)+2*y(10)-(1-mu)*(y(1)+mu)/(r1s)^3-mu/r2s^3*(y(7)-(1-mu))))-2*ceta*w*(y(9)-y(3))-w^2*(y(7)-y(1)));
uy=0;%(1/2)*((axr-(y(8)-2*y(9)-(1-mu)*y(8)/(r1s)^3-mu*y(8)/(r2s)^3))-2*ceta*w*(y(9)-y(3))-w^2*(y(7)-y(1)));
dydt=[y(3);
      y(4);
