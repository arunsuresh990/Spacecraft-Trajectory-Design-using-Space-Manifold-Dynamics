function L1GL2Etransfer%left unstable of L2 and right stable of L1
format long;
mu = 7.802e-5;
mu1=1-mu;
epsilon=2*10^(-5);
...
haloPeriod=3.161440780756263;
i0=[ 0.965251234321497;0;0; 0.046053059097282];% c=3.0075940671432188,halfway  0.971739872159348   0.000000176717469  -0.000000000000000  -0.007702968963519
c1= jacobi(i0(1),i0(2),i0(3),i0(4))%3.00576
%hillscurve(c1);
T=3.1*haloPeriod;
k=40;
numSteps=300;
...
haloPeriod=3.259369112485062;
i0=[ 1.020104822192114;0;0;0.053526694481061];% c=3.0075940671432188,halfway  0.971739872159348   0.000000176717469  -0.000000000000000  -0.007702968963519
