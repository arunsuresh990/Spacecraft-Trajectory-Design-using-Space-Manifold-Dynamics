...
haloPeriod= 2.844817601905718;
i0=[0.815962663748295;0;0; 0.207251594544538];% c=3.0075940671432188,halfway  0.971739872159348   0.000000176717469  -0.000000000000000  -0.007702968963519
c1= jacobimu(i0(1),i0(2),i0(3),i0(4),mu)%3.00576
%hillscurve(c1);
T=3.1*haloPeriod;
k=40;
numSteps=300;
...
[t1,y1,te1,ye1,ie1] = ode113(@f,tspan,y0,options);
[m,p]=size(y1);
pl1(n,1:4)=y1(m,:);
...
haloPeriod= 3.420555832978371;
i0=[1.118284730835350;0;0;0.185998679020517];% c=3.0075940671432188,halfway  0.971739872159348   0.000000176717469  -0.000000000000000  -0.007702968963519
c= jacobimu(i0(1),i0(2),i0(3),i0(4),mu)%3.00576
%hillscurve(c);
k=40;
numSteps=300;
tspan=linspace(0,haloPeriod+0.1*haloPeriod,numSteps);
